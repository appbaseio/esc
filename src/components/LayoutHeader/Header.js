        ...
        <Container>
          <div
            ...
            <a
              ...
              href="https://github.com/appbaseio/esc">
              <span
                css={{
                  color: 'inherit',
                  marginLeft: 10,
            ...
            <nav
              ...
              <HeaderLink
                isActive={location.pathname === '/' || location.pathname === '/esc/' || location.pathname === '/esc'}
                title="Home"
                to="/"
              />
              <HeaderLink
                isActive={location.pathname.includes('/searchbar/')}
                title="Docs"
                to="/searchbar/introduction.html"
              />
            </nav>
