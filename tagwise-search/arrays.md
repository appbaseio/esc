...
This article is a part of the series on [**How to build tag wise search functionality with Elasticsearch?**](https://github.com/appbaseio/esc/blob/master/tagwise-search/introduction.md).

## How to store data using Elasticsearch arrays

This post, provides you the overview of Elasticsearch array datatype. 
